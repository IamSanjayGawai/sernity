  ...
  const amenities = [
    {
      ...
      description: "Landscaping on top terrace.",
      color: "from-green-400 to-green-600",
    },
    {
      icon: Building2,
      title: "Lift (KONE brand) / Equivalent",
      description: "Lift (KONE brand) / Equivalent.",
      color: "from-gray-400 to-gray-600",
    },
    {
      icon: Layers,
      title: "Interlocking Pavers",
      description: "Interlocking pavers / Concrete finish for surroundings.",
      color: "from-yellow-400 to-yellow-600",
    },
    {
      icon: Car,
      title: "Individual Car Charging",
      description: "Individual car charging point in Parking.",
      color: "from-blue-400 to-blue-600",
    },
    {
      icon: Trees,
      title: "Landscape Surroundings",
      description: "Good landscape surroundings adjoining the compound wall.",
      color: "from-green-500 to-green-700",
    },
    {
      icon: Mail,
      title: "Letter Box",
      description: "Letter Box for every unit.",
    ...
    },
    {
      ...
      description: "Parking on ground floor.",
      color: "from-gray-500 to-gray-700",
    },
    {
      icon: DoorOpen,
      title: "Main Gate",
      description: "Well-designed Main Gate.",
      color: "from-purple-500 to-purple-700",
    },
    {
      icon: SlidersHorizontal,
      title: "Auto Level Controller for UGWT",
      description: "Auto level controller for underground water tank.",
...
const projectSpecifications = [
  {
    title: "Structure",
    specs: [
      { icon: Building2, title: "Earthquake resistant RCC structure" },
      { icon: Building2, title: "AAC Blocks Masonry" },
    ],
  },
  {
    title: "Plaster",
    specs: [
      { icon: Layers, title: "Ext – Double coat cement plaster" },
      { icon: Layers, title: "Int – Cement Plaster with smooth gypsum finish" },
    ],
  },
  {
    title: "Bathrooms",
    specs: [
      { icon: Bath, title: "Glazed tiles up to ceiling height in bathroom" },
      { icon: Bath, title: "Plumbing provision for solar water in common bathroom" },
      { icon: Bath, title: "Jaquar or Equivalent brand sanitary ware" },
      { icon: Bath, title: "Jaquar or Equivalent CP Fittings" },
      { icon: Bath, title: "Solar water Connection in Common Bathroom" },
    ],
  },
  {
    title: "Electrical",
    specs: [
      { icon: Zap, title: "Adequate electrical points with modular switches" },
      { icon: Zap, title: "Concealed copper wiring with circuit breakers" },
      { icon: Zap, title: "TV and wifi point in living room & Master bedroom" },
      { icon: Zap, title: "Provision for water purifier and kitchen exhaust point" },
    ],
  },
  {
    title: "Flooring",
    specs: [
      { icon: LayoutGrid, title: "2’ x 4’ Vitrified Tiles flooring in all rooms" },
      { icon: LayoutGrid, title: "12” x 12” anti-skid ceramic tiles for all bathrooms and balconies" },
    ],
  },
  {
    title: "Security",
    specs: [
      { icon: Shield, title: "CCTV at parking level" },
      { icon: Shield, title: "Security access control in lobby area" },
      { icon: Shield, title: "Video Door Phone at main door" },
    ],
  },
  {
    title: "Kitchen",
    specs: [
      { icon: UtensilsCrossed, title: "Granite Kitchen Platform with stainless steel sink" },
      { icon: UtensilsCrossed, title: "Decorative glazed tiles dado up to lintel level" },
    ],
  },

  {
    title: "Doors",
    specs: [
      { icon: DoorClosed, title: "Laminated main door with Mortise lock" },
      { icon: DoorClosed, title: "Internal – Flush doors with wooden door frames and mortise locks" },
    ],
  },
  {
    title: "Windows",
    specs: [
      { icon: Grid2X2, title: "3 track powder coated aluminium windows with mosquito net" },
      { icon: Grid2X2, title: "Granite frames for all windows" },
      { icon: Grid2X2, title: "MS safety grills for all windows" },
    ],
  },
  {
    title: "Painting",
    specs: [
      { icon: Paintbrush, title: "Internal – OBD" },
      { icon: Paintbrush, title: "External – Apex / Equivalent Paint" },
    ],
  },
];
  ...
  <div className="flex justify-center items-center flex-col">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
      {projectSpecifications.map((category, index) => (
        <div key={index}>
          <h2 className="text-3xl font-bold text-teal-700">{category.title}</h2>
